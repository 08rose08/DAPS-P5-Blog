...
<html>
    ...
    <body id="page-top">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="../CV_NaudinR-en.pdf" target="_blank">CV</a></li>
                    </ul>
                </div>
            </div>
        </nav>
        ...
        <!-- Masthead-->
        <header class="masthead" id="index-header">
        ...
        <section class="bg-black text-white-50 text-center">
            <p class="mb-0">Go back <a href="../../index.php#index-header">Home</a></p>
        </section>
